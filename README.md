...
> ⚠️ **Work in Progress** - Currently setting up project structure. Cleaning logic coming soon.
...
1. Standardizes physical measurements to numeric values
2. Converts currency strings (K/M notation) to actual numbers
3. Cleans text formatting issues
4. Outputs analysis-ready CSV

**Input:** `data/raw/fifa21 raw data v2.csv`  
**Output:** `data/processed/fifa21_clean.csv`
